...
namespace Modules\TomatoArtisan\App\Http\Controllers;
...
class ArtisanController extends  Controller {
    ...
    {
        if(is_developer() || !config('tomato-artisan.developer_mode')){
            $commands = $this->prepareToJson(config('tomato-artisan.commands', []));
            return view('tomato-artisan::index', compact('commands'));
        }
    ...
    public function run(Request $request)
    {
        if(is_developer() || !config('tomato-artisan.developer_mode')) {
            ...
            $permissions = config('tomato-artisan.permissions', []);
