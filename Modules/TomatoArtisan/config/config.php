...
return [
    /*
     ...
     |--------------------------------------------------------------------------
     |
     | developer mode use Tomato-Roles package to secure artisan commands with
     | developer password leave on tomato-roles.php config file.
     */
    'developer_mode' => env('ARTISAN_DEVELOPER_MODE', true),
