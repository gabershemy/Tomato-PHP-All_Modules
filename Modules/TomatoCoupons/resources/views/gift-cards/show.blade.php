<x-tomato-admin-container label="{{ trans('tomato-admin::global.crud.view') }} {{ __('Gift Cards') }} #{{ $model->id }}">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <x-tomato-admin-row :label="__('Is expired')" :value="$model->is_expired" type="bool" />

    </div>
    <div class="flex justify-start gap-2 pt-3">
        <x-tomato-admin-button warning label="{{ __('Edit') }}" :href="route('admin.gift-cards.edit', $model->id)" />
