<section>
    ...
    <x-splade-form method="post" :action="route('profile.update')" :default="$user"  class="mt-6 space-y-6">
        ...
        <x-splade-input id="phone" name="phone" type="tel" :label="__('Phone')" required autocomplete="phone" />
