                ...
                <div class="filament-modal-content">
                    <div class="flex flex-col gap-4">
                        @foreach($notifications as $notification)
                            <div>
                                <div class="flex flex-col gap-4 rounded-lg @if(!$notification->isRead()) bg-gray-200 dark:bg-gray-700 @else bg-gray-50 dark:bg-gray-900 @endif  px-4 py-4">
                                    <div
                    ...
                    <div class="my-4 border border-gray-200 dark:border-gray-700"></div>
