<x-tomato-admin-container label="{{trans('tomato-admin::global.crud.edit')}} {{__('Shipping Price')}} #{{$model->id}}">
    <x-splade-form class="flex flex-col space-y-4" action="{{route('admin.shipping-prices.update', $model->id)}}" method="post" :default="$model">
