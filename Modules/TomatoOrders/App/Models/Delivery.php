...
class Delivery extends Model
{
    ...
    public function vendor(){
        return $this->belongsTo('Modules\TomatoOrders\App\Models\ShippingVendor', 'shipping_vendor_id');
    }
    /**
    ...
    {
        return $this->hasMany('Modules\TomatoOrders\App\Models\Order', 'shipper_id');
    }
