...
class InvoicesItem extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['invoice_id', 'type', 'item_type', 'item_id', 'item', 'description', 'note', 'qty', 'price', 'discount', 'tax', 'total', 'returned_qty', 'returned', 'is_free', 'is_returned', 'options', 'created_at', 'updated_at'];
