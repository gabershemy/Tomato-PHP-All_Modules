...
namespace Modules\TomatoInvoices\App\Http\Controllers;
...
class InvoiceController extends Controller
{
    ...
    {
        $this->model = \Modules\TomatoInvoices\App\Models\Invoice::class;
    }
    ...
    public function index(Request $request): View|JsonResponse
    {
        return Tomato::index(
            ...
            table: \Modules\TomatoInvoices\App\Tables\InvoiceTable::class
        );
    }
    ...
    public function api(Request $request): JsonResponse
    {
        return Tomato::json(
            request: $request,
            model: \Modules\TomatoInvoices\App\Models\Invoice::class,
        );
    }
    ...
    /**
     * @param \Modules\TomatoInvoices\App\Models\Invoice $model
     * @return View|JsonResponse
     */
    public function show(\Modules\TomatoInvoices\App\Models\Invoice $model): View|JsonResponse
    {
     ...
     * @return View|JsonResponse
     */
    public function printIt(\Modules\TomatoInvoices\App\Models\Invoice $model): View|JsonResponse
    {
        $model->from_id = $model->from_type::find($model->from_id);
        $model->for_id = $model->for_type::find($model->for_id);
        return Tomato::get(
     ...
     * @return View
     */
    public function edit(\Modules\TomatoInvoices\App\Models\Invoice $model): View
    {
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function update(Request $request, \Modules\TomatoInvoices\App\Models\Invoice $model): RedirectResponse|JsonResponse
    {
        $request->validate([
     ...
     * @return RedirectResponse|JsonResponse
     */
    public function destroy(\Modules\TomatoInvoices\App\Models\Invoice $model): RedirectResponse|JsonResponse
    {
