...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
                       "admin.payment-logs.index",
           "admin.payment-logs.api",
           "admin.payment-logs.create",
           "admin.payment-logs.store",
           "admin.payment-logs.show",
           "admin.payment-logs.edit",
           "admin.payment-logs.update",
           "admin.payment-logs.destroy",
           "admin.payment-logs.export",
           "admin.payment-logs.bulk",
