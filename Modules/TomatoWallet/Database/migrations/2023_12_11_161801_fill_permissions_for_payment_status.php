...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
                       "admin.payment-status.index",
           "admin.payment-status.api",
           "admin.payment-status.create",
           "admin.payment-status.store",
           "admin.payment-status.show",
           "admin.payment-status.edit",
           "admin.payment-status.update",
           "admin.payment-status.destroy",
           "admin.payment-status.export",
           "admin.payment-status.bulk",
