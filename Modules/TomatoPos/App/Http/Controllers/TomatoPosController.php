...
namespace Modules\TomatoPos\App\Http\Controllers;
...
use Modules\TomatoPos\App\Models\PosSetting;
...
use Modules\TomatoInventory\App\Tables\InventoryTable;
...
class TomatoPosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $products = \Modules\TomatoProducts\App\Models\Product::query();
        ...
        $cart = \Modules\TomatoEcommerce\App\Models\Cart::where('session_id', $currentSession)->orderBy('id', 'desc')->get();
    ...
    public function clear(){
        $currentSession = $this->getSessionID();
        \Modules\TomatoEcommerce\App\Models\Cart::where('session_id', $currentSession)->delete();
