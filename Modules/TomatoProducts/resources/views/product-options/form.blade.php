<x-tomato-admin-container :label="isset($item) ? __('Update Option') : __('Add Option')">
    <x-splade-form method="POST" action="{{route('admin.products.options.store', $type)}}" :default="$item ?? [
        'for' => 'product-options',
        'type' => $type
    ]">
